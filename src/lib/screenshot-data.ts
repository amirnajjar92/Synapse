  ...
  tables: [
    {
      ...
      title: 'WEEK 1 — PUSH A',
      rows: [
        { id: 'r1', columns: ['Monday', 'Chest / Shoulders', 'Bench Press: 4x8\nIncline Dumbbell Press: 3x10\nLateral Raise: 4x12\nOverhead Press: 3x8\nTricep Pushdown: 3x12', '60 min'] },
        { id: 'r2', columns: ['Tuesday', 'Back / Rear Delts', 'Pull Ups: 4x8\nBarbell Row: 4x10\nFace Pull: 3x15\nDeadlift: 3x5\nHammer Curl: 3x10', '60 min'] },
        { id: 'r3', columns: ['Wednesday', 'Legs', 'Squat: 4x6\nRomanian Deadlift: 3x10\nLeg Press: 3x12\nCalf Raise: 4x15\nPlank: 3x45s', '65 min'] },
        { id: 'r4', columns: ['Thursday', 'Push B', 'Incline Bench: 4x8\nDips: 3x10\nArnold Press: 3x10\nSkull Crusher: 3x12\nFace Pull: 3x15', '55 min'] },
        { id: 'r5', columns: ['Friday', 'Pull B', 'Lat Pulldown: 4x10\nSeated Row: 3x12\nRack Pull: 3x8\nEZ Bar Curl: 3x12\nRear Delt Fly: 3x15', '55 min'] },
        { id: 'r6', columns: ['Saturday', 'Legs / Abs', 'Front Squat: 4x6\nLunges: 3x10\nLeg Curl: 3x12\nHanging Leg Raise: 3x12\nCable Crunch: 3x15', '60 min'] },
        { id: 'r7', columns: ['Sunday', 'Rest / Recovery', 'Light Cardio: 30 min\nStretching: 20 min\nFoam Rolling: 15 min', '65 min'] },
      ],
    },
  ],
};
